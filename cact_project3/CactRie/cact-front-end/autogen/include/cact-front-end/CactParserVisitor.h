...
public:
   ...
   */
    ...
    virtual std::any visitDataType(CactParser::DataTypeContext *context) = 0;
    ...
    virtual std::any visitFunctionParameters(CactParser::FunctionParametersContext *context) = 0;

    virtual std::any visitFunctionParameter(CactParser::FunctionParameterContext *context) = 0;
    ...
    virtual std::any visitFunctionArguments(CactParser::FunctionArgumentsContext *context) = 0;
